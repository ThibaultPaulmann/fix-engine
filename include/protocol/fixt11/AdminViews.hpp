...
struct LogonView {
  ...
  static bool is(const fix::core::Message& m) {
    auto t = m.get_sv(fix::core::tags::MsgType); return t && *t == fix::core::msg::Logon;
  }
...
struct LogoutView {
  const fix::core::Message& m;
  static bool is(const fix::core::Message& m) {
    auto t = m.get_sv(fix::core::tags::MsgType); return t && *t == fix::core::msg::Logout;
  }
...
struct HeartbeatView {
  const fix::core::Message& m;
  static bool is(const fix::core::Message& m) {
    auto t = m.get_sv(fix::core::tags::MsgType); return t && *t == fix::core::msg::Heartbeat;
  }
...
struct TestRequestView {
  const fix::core::Message& m;
  static bool is(const fix::core::Message& m) {
    auto t = m.get_sv(fix::core::tags::MsgType); return t && *t == fix::core::msg::TestRequest;
  }
  std::optional<std::string_view> test_req_id() const { return m.get_sv(fix::core::tags::TestReqID); }
};
...
struct ResendRequestView {
  const fix::core::Message& m;
  static bool is(const fix::core::Message& m) {
    auto t = m.get_sv(fix::core::tags::MsgType); return t && *t == fix::core::msg::ResendRequest;
  }
...
struct RejectView {
  const fix::core::Message& m;
  static bool is(const fix::core::Message& m) {
    auto t = m.get_sv(fix::core::tags::MsgType); return t && *t == fix::core::msg::Reject;
  }
...
struct SequenceResetView {
  const fix::core::Message& m;
  static bool is(const fix::core::Message& m) {
    auto t = m.get_sv(fix::core::tags::MsgType); return t && *t == fix::core::msg::SequenceReset;
  }
